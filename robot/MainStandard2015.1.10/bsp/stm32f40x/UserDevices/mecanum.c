...
double coeff_x,coeff_y,coeff_r; //雅克比矩阵化简后的系数

//struct Mecanum_State Mec_FL={W_MOTOR1_SPEED_ID, 1};		//四轮的状态参数
...
struct Mecanum_State Mec_FL={4, -1};		//四轮的状态参数
struct Mecanum_State Mec_FR={3,  1};
struct Mecanum_State Mec_BL={2, -1};
struct Mecanum_State Mec_BR={1,  1};

static double robo_L = 636.6;//左右轮距
static double robo_W = 636.2;//前后轮距
